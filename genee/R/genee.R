...
genee <- function(mydata, ld, alpha, upper, lower, prior_weight, gene_list){
  ...
  if(alpha == -1){
    ...
    tempresults = genee_regularize(betas_ols = betas_ols, alpha = alpha, ld = ld, prior_weight = prior_weight, gene_list = gene_list)
  }
